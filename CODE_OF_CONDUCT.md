...
- sharing filenames, paths, screenshots, history records, or other data that
  reveals someone else's private information;
...
published private conduct-reporting channel.

This repository does not yet have a verified public contact address. Before the
first public release, maintainers must publish and test a private conduct
contact as required by [the release checklist](docs/release-checklist.md).
Until then:

- do not place sensitive conduct details in a public issue;
- use GitHub's built-in abuse reporting for content hosted on GitHub when
  immediate platform action is needed;
- follow [SECURITY.md](SECURITY.md) instead when the report is about a software
  vulnerability.
